        ...
        <>
          ...
          <Container>
            <Row className="justify-content-center align-items-center min-vh-100">
              <Col md={6}>
                ...
                <h3 className="ps-5">{restaurant.name}</h3>
                <Row className="ps-5">
                  <Col md={6}>
                    <p>
              ...
              <Col xl={6} className="service">
                <div>
                  <h3 className="specialities">
                    <PiChefHatThin color="orange" /> Vẻ đẹp nghệ thuật trong
                    dịch vụ
                  </h3>
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
          ...
          <Container className="image-container">
            <div className="block-inferior mb-5">
              <Image
                className="image-inferior"
                src={vegetablesTableImage}
                fluid
              />
            </div>
            ...
            <Row className="overlay-content">
              <Col md={6}>
                <Row>
                  ...
                  <Col md={6}>
                    <p>LIÊN HỆ ĐẶT BÀN : {restaurant.phone}</p>
                    <p>
                      Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    </p>
                  </Col>
